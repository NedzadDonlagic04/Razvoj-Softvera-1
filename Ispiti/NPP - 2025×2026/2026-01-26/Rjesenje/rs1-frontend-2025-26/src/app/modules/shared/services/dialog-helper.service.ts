...
export class DialogHelperService {
  ...
  productCategory = {
    confirmDelete: (categoryName: string) => {
      return this.confirmDelete(categoryName, 'PRODUCT_CATEGORIES.DIALOGS.DELETE_MESSAGE');
    },
    ...
    showCreateError: () => {
      return this.showError('DIALOGS.TITLES.ERROR', 'PRODUCT_CATEGORIES.DIALOGS.ERROR_CREATE');
    },

    showUpdateError: () => {
      return this.showError('DIALOGS.TITLES.ERROR', 'PRODUCT_CATEGORIES.DIALOGS.ERROR_UPDATE');
    },

    showDeleteError: () => {
      return this.showError('DIALOGS.TITLES.ERROR', 'PRODUCT_CATEGORIES.DIALOGS.ERROR_DELETE');
    },
  };
   ...
   */
  dostavljac = {
    confirmDelete: (dostavljacName: string) => {
      return this.confirmDelete(dostavljacName, 'Da li zelite obrisati dostavljaca?');
    },

    confirmCancel: () => {
      return this.confirm('PRODUCTS.DIALOGS.UNSAVED_CHANGES', 'PRODUCTS.DIALOGS.CONFIRM_CANCEL');
    },

    showCreateSuccess: () => {
      return this.showSuccess('DIALOGS.TITLES.SUCCESS', 'PRODUCTS.DIALOGS.SUCCESS_CREATE');
    },

    showUpdateSuccess: () => {
      return this.showSuccess('DIALOGS.TITLES.SUCCESS', 'PRODUCTS.DIALOGS.SUCCESS_UPDATE');
    },

    showDeleteSuccess: () => {
      return this.showSuccess('DIALOGS.TITLES.SUCCESS', 'PRODUCTS.DIALOGS.SUCCESS_DELETE');
    },

    showCreateError: () => {
      return this.showError('DIALOGS.TITLES.ERROR', 'PRODUCTS.DIALOGS.ERROR_CREATE');
    },

    showUpdateError: () => {
      return this.showError('DIALOGS.TITLES.ERROR', 'PRODUCTS.DIALOGS.ERROR_UPDATE');
    },

    showDeleteError: () => {
      return this.showError('DIALOGS.TITLES.ERROR', 'PRODUCTS.DIALOGS.ERROR_DELETE');
    },
  };
}
