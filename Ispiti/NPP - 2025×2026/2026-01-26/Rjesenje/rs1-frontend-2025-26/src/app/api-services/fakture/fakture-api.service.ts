...
import { CreateFakturaCommand, ListFaktureResponse } from './fakture-api.models';
...
export class FaktureApiService {
  ...
  create(payload: CreateFakturaCommand): Observable<number> {
  ...
  list(pageNumber: number = 1, pageSize: number = 10): Observable<ListFaktureResponse> {
    const params = new HttpParams()
      .set('Paging.Page', pageNumber.toString())
